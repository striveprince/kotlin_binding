package com.eWord.inquiry.base.util
...
import com.eWord.inquiry.base.util.FileUtils.getFilePathByUri
...
class PhoneSystemManager : AppCompatActivity() {
    ...
    private fun takePhoto() {
        photoFile = File(Environment.getExternalStorageDirectory().toString() + ActivityComponent.Config.tomtaw + System.currentTimeMillis() + ".jpg")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        } else if (resultCode == Activity.RESULT_OK) emitter?.onNext(File(data?.data?.let { getFilePathByUri(this, it) }!!)) else if(requestCode== GPS_REQUEST_CODE){
